                ...
                <div class="col-sm-6 col-md-3">
                    <div class="footer-links">
                        ...
                        <div class="footer-link-list">
                            <a href="{{ route('register') }}" class="footer-links">Register <span
                                    class="badge badge-primary">Free</span></a>
                    ...
                    <div class="footer-links">
                        ...
                        <div class="footer-link-list">
                            <a href="#" class="footer-links"><i class="fas fa-compass"></i>
                                Joblister Platform</a>
                            <a href="tel:254711971251" class="footer-links"><i class="fas fa-phone"></i>
                                +2547-1197-1251</a>
                            <a href="tel:254731247872" class="footer-links"><i class="fas fa-mobile"></i>
                                +2547-3124-7872</a>
                            <a href="mailto:info@joblister.com" class="footer-links"><i class="fas fa-envelope"></i>
                                info@joblister.com</a>
